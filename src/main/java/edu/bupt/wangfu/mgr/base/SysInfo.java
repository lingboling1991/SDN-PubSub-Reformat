...
public abstract class SysInfo {
	...
	public static ConcurrentHashMap<String, Broker> groups;//TODO ？怎么个意思？当前拓扑内，其他所有集群的信息，key为集群名；用的时候直接向controller请求
	public static ConcurrentHashMap<String, Broker> neighbors; //邻居集群，与上面groupMap区分开，这个是直接连接的；
