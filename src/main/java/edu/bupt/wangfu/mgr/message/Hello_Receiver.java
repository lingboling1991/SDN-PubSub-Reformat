...
//		if (groupName.equals(mh_.dstGroup) && outSwtMap.containsKey(mh_.dstPort)) {
//			//更新邻居信息
...
//		lost.start();
	...
	private class LostTask implements Runnable {
		...
		@Override
		public void run() {
			/*for (Port port : outSwtMap.values()) {
